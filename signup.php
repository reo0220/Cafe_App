...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(!isset($error1) && !isset($error2) && !isset($error3) && !isset($error4)){
            try{
                $dbh = new PDO('mysql:host=lmag6s0zwmcswp5w.cbetxkdyhwsb.us-east-1.rds.amazonaws.com;dbname=aebifro9tkb2dfum','yao2hpzrt6mfkfn1','ck3eakt3fp2npl6a',//データベース接続
                    array(
                ...
                $dbh1 = new PDO('mysql:host=lmag6s0zwmcswp5w.cbetxkdyhwsb.us-east-1.rds.amazonaws.com;dbname=aebifro9tkb2dfum','yao2hpzrt6mfkfn1','ck3eakt3fp2npl6a');
